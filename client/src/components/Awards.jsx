        ...
        <>
            <div variants={textVariant()}>
                <p className={`${styles.sectionSubText} `}>
                    Where Imagination Takes Form: A Showcase of My Awards</p>
                <h2 className={`${styles.sectionHeadText}`}>Awards & Recognition.</h2>
            </div>
            ...
            <div className='mt-20 flex flex-wrap gap-7'>
                {awards.map((project, index) => (
                    <AwardsCard key={`project-${index}`} index={index} {...project} />
                ))}
            </div>
        </>
    );
